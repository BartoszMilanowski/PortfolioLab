...
insert into charity_donation.donations (quantity, institution_id, street, city, zip_code, pick_up_date, pick_up_time, pick_up_comment, status, donator_id, registered) values (2, 1, 'Główna 5', 'Warszawa', '01-001', '2022-06-08', '10:00:00', 'istotny komentarz', false, 1, '2022:06:05');
insert into charity_donation.donations (quantity, institution_id, street, city, zip_code, pick_up_date, pick_up_time, pick_up_comment, status, donator_id, picked_up, registered) values (1, 2, 'Główna 6', 'Warszawa', '01-001', '2022-06-02', '11:30:00', 'istotny komentarz', true, 1, '2022-06-02', '2022-05-20');
