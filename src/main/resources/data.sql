...
# insert into charity_donation.users (email, enabled, first_name, last_name, password, role_id) VALUES ('grzegorz@brzeczyszczykiewicz.pl', 1, 'Grzegorz', 'Brzeczyszczykiewicz', '$2a$12$aQ95vY7DFoQif0/h8dQX4.NPiWBDswcCw5cm0pNOp31gLanzinwaq', 2);
